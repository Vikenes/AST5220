...
\begin{figure}[ht!]
    \includefig{deltas_k_001_01_1}
    \includefig{delta_gamma_k_001_01_1}
...
\begin{figure}[ht!]
    \includefig{vels_k_001_01_1}
    \caption{Evolution of $\vcdm$ (solid line) and $\vb$ (dashed line) for three different modes.}
    \label{fig:M3:results:vel_CDM_b}
\end{figure}

In \figref{fig:M3:results:vel_photon_b} we plot $\vb$ and $\vg$ using a linear scale. At early times, during the tight coupling regime, we have $\vb=\vg$. We see that decoupling between photons and baryons is evident for all three modes of consideration here.  
...
\begin{figure}[ht!]
    \includefig{Phi_plus_Psi_k_001_01_1}
